...
@implementation XXCoreTextView

/*
  第一步 注释1----7步 以外的代码  运行看效果
  第二步 打开第8步注释  运行看效果
  第三步 打开9、10、11步  运行看效果
*/
- (void)drawRect:(CGRect)rect{
    ...
    NSMutableAttributedString *attrString = [[NSMutableAttributedString alloc] initWithString:@"iOS给朋友们的养分，CoreText图文混排的基础，进阶篇可以去唐巧的博客学习，你将学会如何图文混排之后，给内容添加点击事件等高端大气上档次的技术，给你超赞的体验，带你装bbbBBB带你飞~~!@#$%^&*()_iOS给朋友们的养分，CoreText图文混排的基础，进阶篇可以去唐巧的博客学习，你将学会如何图文混排之后，给内容添加点击事件等高端大气上档次的技术，给你超赞的体验，带你装bbbBBB带你飞~~!@#$%^&*()_iOS给朋友们的养分，CoreText图文混排的基础，进阶篇可以去唐巧的博客学习，你将学会如何图文混排之后，给内容添加点击事件等高端大气上档次的技术，给你超赞的体验，带你装bbbBBB带你飞~~!@#$%^&*()_iOS给朋友们的养分，CoreText图文混排的基础，进阶篇可以去唐巧的博客学习，你将学会如何图文混排之后，给内容添加点击事件等高端大气上档次的技术，给你超赞的体验，带你装bbbBBB带你飞~~!@#$%^&*()_iOS给朋友们的养分，CoreText图文混排的基础，进阶篇可以去唐巧的博客学习，你将学会如何图文混排之后，给内容添加点击事件等高端大气上档次的技术，给你超赞的体验，带你装bbbBBB带你飞~~!@#$%^&*()_"];
    ...
    // 图片信息字典
    NSDictionary *imgInfoDic = @{@"width":@200,@"height":@100};
